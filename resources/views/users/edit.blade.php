    ...
    <div class="card-body">
        <form method="POST" action="{{ route('users.update', $user) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" id="user-name-input" class="form-control" value="{{ old('name', $user->name) }}" required autofocus>
...
<script>
    ...
    // Debounced AJAX check for name availability (same as create)
    (function() {
        var timer = null;
        var input = document.getElementById('user-name-input');
